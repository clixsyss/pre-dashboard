// node importTelalSokhnaUnits.mjs
...
// Project ID for Telal Sokhna
const PROJECT_ID = '2omCgcFTjCsR52XdNGGz';

// Excel file name (place it in the same directory as this script)
const EXCEL_FILE_NAME = 'telal_sokhna_units.xlsx';
 ...
 * For telal_sokhna_units.xlsx: columns are "developer", "unit", and "building"
...
async function importUnits() {
  console.log('🚀 Starting Telal Sokhna units import process...\n');
